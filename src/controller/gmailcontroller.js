...
async function listUnreadMessages(auth) {
  ...
  for (const message of messages) {
    ...
    const autoReplyText = `Hi ,I am currently out of office and will not be available to respond to emails until 30th of april. Thank you for your understanding!Best regards,Madhuri`;
